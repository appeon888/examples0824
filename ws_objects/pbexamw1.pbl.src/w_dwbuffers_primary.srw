HA$PBExportHeader$w_dwbuffers_primary.srw
$PBExportComments$Sheet to display the DataWindow (represents the Primary buffer)
forward
global type w_dwbuffers_primary from w_dwbuffers_ancestor
end type
end forward
...
global w_dwbuffers_primary w_dwbuffers_primary
...
on w_dwbuffers_primary.create
call w_dwbuffers_ancestor::create
end on

on w_dwbuffers_primary.destroy
call w_dwbuffers_ancestor::destroy
end on

type dw_data from w_dwbuffers_ancestor`dw_data within w_dwbuffers_primary
int Width=1737
int Height=560
